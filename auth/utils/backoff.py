...
def backoff(logger=logger, start_sleep_time: object = 0.5, factor: object = 2, border_sleep_time: object = 10) -> object:
    """
        ...
        def inner(*args, **kwargs):
            ...
            while True:
                try:
                    ...
                    logger.error(f'Connection refused from redis: {e}')
